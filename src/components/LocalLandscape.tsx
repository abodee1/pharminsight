                ...
                <div className="flex items-start justify-between gap-2">
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      <p className="font-medium text-sm">{pharmacyDisplayName(p.name, p.trading_name, p.ods_code)}</p>
                  ...
                  <Link
                    ...
                    aria-label={`Add ${pharmacyDisplayName(p.name, p.trading_name, p.ods_code)} to comparison`}
                  >
